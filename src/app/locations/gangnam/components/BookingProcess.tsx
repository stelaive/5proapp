        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid md:grid-cols-3 gap-6 md:gap-8">
            {data.bookingSteps.map((step) => (
              <div 
                key={step.step}
                className="bg-white rounded-xl p-6 border-2 border-gray-100 hover:border-[#F97316]/30 transition-colors text-center"
              >
                <div className="w-12 h-12 md:w-16 md:h-16 text-white rounded-full flex items-center justify-center font-bold text-xl md:text-2xl mx-auto mb-4" style={{ backgroundColor: '#F97316' }}>
                  {step.step}
                </div>
