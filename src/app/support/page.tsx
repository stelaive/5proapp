    ...
    questions: [
      {
        ...
        A: '현재 저희 스카이차 배차 서비스는 제주도를 제외한 전국 어디든 이용 가능합니다! 서울·경기·인천은 물론 대전·충청·강원·경상·전라 등 전국으로 24시간 배차해 드립니다. 반나절·하루 기본 요금은 전국 동일하게 적용되며, 시간 초과 추가금은 일부 지역에서 기준이 다를 수 있어 예약 시 안내해 드립니다.',
        tag: '[요금]'
      },
      {
        Q: '\'반나절\'과 \'하루\' 작업의 기준 시간은 각각 몇 시간인가요? 만약 기준 시간을 조금 넘기면 비용은 어떻게 계산되나요?',
        A: '네, 작업 시간 기준은 명확하게 정해져 있어요! 반나절은 4시간, 하루는 8시간을 기준으로 합니다. 기준 시간을 초과하면 장비별로 추가금이 붙습니다 — 1톤~3.5톤은 시간당 15만원, 5톤(45m)은 시간당 20만원이며, 8톤 이상은 협의로 정합니다. 지역에 따라 추가금 기준이 다를 수 있으니 예약 시 확인해 주세요!',
        tag: '[기준]'
      },
      {
